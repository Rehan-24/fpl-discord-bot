...
def main():
    ...
    if not publish_lines:
        sys.stderr.write("Warning: no /publish_news commands generated by mundo_scraper.py (chmps)\n")

    print(json.dumps({"source": "championship", "commands": publish_lines}, ensure_ascii=False, indent=2))
